function [error,S,sim_Ftotal_cycles,R,integfail_flag,cycle_fail_index,complex_flag]=eval_Pi(params,iemg_profile,cycles, cut_off, Pi_set, met_dyn_set)
    % Experimental data
