...
for i=1:n
    params1 = params;
    params1(23) = params(23)*m_factor(i);
...
%% construct figure 5d
figure(61);clf;
plot(m_factor*params(23)*10^3,force(T_cycles,:),'linewidth',2,'Color','k'); hold on;box on;
xlim([0.3 0.8]);
ylim([260 360])
%xticks(0.25:0.2:0.85)
%yticks(255:20:355)
xlabel('K_{H+} (\muM)','Interpreter','tex');
ylabel('Force (N)');
set(gca,'Unit','Inches')
p = get(gca,'Position');
set(gca,'Unit','Inches','Position',[p(1) p(2) 1.75 1.25]);
exportgraphics(figure(61),fullfile('figure_5_subplots','figure_5_e.pdf'),'BackgroundColor','w','Resolution',300,'ContentType','vector');
